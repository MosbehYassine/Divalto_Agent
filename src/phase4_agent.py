...
from phase4_query_builder import build_training_ready_artifacts, build_ws_payload_guarded
from phase4_tools import list_tools
...
def run_phase4(user_request: str, dataset_output_dir: str | None = None) -> dict[str, Any]:
    ...
    """
    output_dir = dataset_output_dir or str(Path(__file__).resolve().parent.parent / "datasets")
