...
# Directory containing semantic_model.json (+ optional mdx_templates.json) from analytics.auto_olap_pipeline.
...
# Chat answer feedback (thumbs up/down) appended as JSONL for continuous improvement.
FEEDBACK_JSONL_PATH = _get_env("DIVALTO_FEEDBACK_JSONL_PATH", "")
