...
from divalto_agent import call_webservice, get_token, validate_payload
from settings import USE_SQLITE_MOCK
    ...
    *,
    ...
    for step_def in plan:
        ...
        if mock_responses is not None:
            ...
            raw_response = call_webservice(token_for_calls or "", dict(validated_data))
